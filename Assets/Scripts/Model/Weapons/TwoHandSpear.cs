...
{
    [System.Serializable]
    public sealed class TwoHandSpear: Weapon
    {
        #region Fields

        [SerializeField] private WeaponAttachmentPoint _attachmentPoint = WeaponAttachmentPoint.TwoHandsRight;
        [SerializeField] private WeaponType _weaponType = WeaponType.TwoHandSpear;
        ...
        protected override int CountVariantsAttack  => 11;

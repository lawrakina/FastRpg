...
namespace Model.Ai
{
    public class Bot : BaseUnitModel, ISelectObj
    {
        #region Properties

        public Vision Vision;
        public FpsWeapon _fpsWeapon; //todo с разным оружием 
            ...
            set
            {
                ...
                switch (value)
                {
                    ...
                    case StateBot.Patrol:
                        Color = Color.green;
                        AnimatorParams.Move = true;
                        // CashAnimator.SetFloat(TagManager.ANIMATOR_PARAM_MOVE, 1.0f);
                        break;
                    case StateBot.Inspection:
                        Color = Color.yellow;
                        AnimatorParams.Move = false;
                        // CashAnimator.SetFloat(TagManager.ANIMATOR_PARAM_MOVE, 0.0f);
                        break;
